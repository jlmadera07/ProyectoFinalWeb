...
searchBar.addEventListener("input", (e) => {
    ...
    let filteredProducts = productos.filter(producto => producto.titulo.toLowerCase().includes(searchTerm));

    // Filtrar productos por categoría actual
    if (categoriaActual !== "todos") {
        filteredProducts = filteredProducts.filter(producto => producto.categoria.id === categoriaActual);
    }
